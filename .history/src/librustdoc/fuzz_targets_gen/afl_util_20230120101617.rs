...
pub trait AflHelper {
    ...
    pub fn generate_u8_to_other_type_function_name(&self) -> String;
    pub fn generate_u8_to_other_type_function(&self) -> String;
}

impl AflHelper for FuzzType {
    /// 获取类型名称，Tuple是空
        ...
        match self.ty {
            ...
            | Isize | F32 | F64 => {
                format!(
                    ...
                    afl_helper_function_name = self.ty.generate_u8_to_other_type_function_name(),
            ...
            Tuple(inners) => {
                ...
                for i in 0..inner_afl_helpers_number {
                    ...
                    let afp = AflForParams { ty: *inner };

                    let inner_rhs = afp.generate_param_initial_rhs(
                    ...
                    inner_fixed_start_index = inner_fixed_start_index + inner._fixed_part_length();
                    inner_dynamic_param_index =
