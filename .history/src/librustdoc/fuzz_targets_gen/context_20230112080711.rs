...
use crate::fuzz_targets_gen::extract_seq::{extract_sequence, ExtractSequence};
...
impl<'tcx> FormatRenderer<'tcx> for Context<'tcx> {
    ...
    fn init(
        ...
        let _ = tcx.sess.time("build_call_graph", || {
            ...
            let extract_sequemce = ExtractSequence::new();
            extract_sequemce.extract_sequence(tcx, all_dependencies, true)
            extract_sequence(tcx, all_dependencies, false);
        });
