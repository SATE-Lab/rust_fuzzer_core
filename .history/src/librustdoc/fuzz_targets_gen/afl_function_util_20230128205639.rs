...
impl AflFunctionHelper {
    ...
    pub fn generate_afl_except_main(&self, test_index: usize) -> String {
        ...
        res.push_str(self.generate_well_written_function(test_index, 0).as_str());
        res.push('\n');
        res
    }

    pub fn generate_well_written_function(&self, test_index: usize, indent_size: usize) -> String {
