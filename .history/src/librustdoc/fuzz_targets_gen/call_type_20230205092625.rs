...
use super::api_util::FullNameMap;
    ...
    pub fn _to_call_string(
        ...
        match self {
            ...
            CallType::_BorrowedRef(inner_) => {
                ...
                let inner_call_string = inner_._to_call_string(tcx, variable_name, full_name_map);
            ...
            CallType::_ConstRawPointer(inner_, ty_) => {
                ...
                call_string.push_str(rustc_middle::ty::print::with_no_trimmed_paths!({
                    format!("{}", ty_)
                }));
                call_string
            }
