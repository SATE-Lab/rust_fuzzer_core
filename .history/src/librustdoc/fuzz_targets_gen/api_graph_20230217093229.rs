//! api图，从源代码依靠clean的数据结构解析出来
//! 核心数据结构，所有的操作都在此基础上完成
//!
...
/// 有如下field
/// crate_name: 当前被解析的crate名称
/// api_functions: 当前crate里面所有的api，不过中间需要经过过滤
/// api_dependencies: 跟据api参数和返回值类型构建依赖关系
/// api_sequences: 根据依赖关系和算法，生成的函数序列
///
/// full_name_map: 全限定名称的字典
/// mod_visibility: 可见性，用于修复
/// generic_function: 泛型，暂不支持
#[derive(Clone, Debug)]
