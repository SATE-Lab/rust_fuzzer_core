...
fn print_dependencies(dep : &IndexVec<mir::Local, BitVec>){
    println!("\nBegin to print dependencies");
    
    for local_vec in &self.dependencies {
                             ...
                             callsites
                                 ...
                                 .map(|callsite| {
                                     ...
                                     match callsite.function {
                                         DirectCall(callee) => {
                                            //FIXME:
                                            println!(" local is {}, callee is {}",local.as_usize(), tcx.def_path_str(callee));
