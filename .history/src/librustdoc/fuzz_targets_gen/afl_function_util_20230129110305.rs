...
impl AflFunctionHelper {
    ...
    pub fn generate_test_function(&self, test_index: usize, indent_size: usize) -> String {
        ...
        //生成函数头
        let function_header = self.generate_function_header(test_index, indent_size);
    ...
    fn generate_function_header(&self, test_index: usize, tab_num: usize) -> String {
    ...
    /*
        pub fn generate_function_body_string(
            ...
            //api_calls
            for (i, api_call) in self.api_seq.function_sequence.iter().enumerate() {
                //准备参数
