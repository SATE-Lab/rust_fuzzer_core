...
impl ToAfl {
    pub fn generate_u8_to_other_type_function(fuzz_type: FuzzType) -> &'static str {
        match fuzz_type {
            _NoHelper => "afl no helper",
            _U8 => _data_to_u8(),
            _I8 => _data_to_i8(),
            _U16 => _data_to_u16(),
            _I16 => _data_to_i16(),
            ...
            _U128 => _data_to_u128(),
            _I128 => _data_to_i128(),
            _Usize => _data_to_usize(),
            _Isize => _data_to_isize(),
            _Char => _data_to_char(),
            _Bool => _data_to_bool(),
            _Str => _data_to_str(),
            _Slice(..) => _data_to_slice(),
            _Tuple(..) => "",
        }
    }
}
