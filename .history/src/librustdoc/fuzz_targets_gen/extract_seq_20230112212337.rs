...
impl FunctionInfo<'_> {
    ...
    pub fn new_by_caller_def_id<'tcx>(tcx: TyCtxt<'tcx>, def_id: DefId, all) -> FunctionInfo<'_> {
    ...
    pub fn new_by_callee_def_id<'tcx>(tcx: TyCtxt<'tcx>, def_id: DefId) -> FunctionInfo<'_> {
