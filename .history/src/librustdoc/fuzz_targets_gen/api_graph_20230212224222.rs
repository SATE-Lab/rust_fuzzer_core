...
impl Debug for Cache {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("Cache")
            ...
            .field("external_paths", &self.external_paths)
            .field("exact_paths", &self.exact_paths)
            .field("traits", &self.traits)
            .field("implementors", &self.implementors)
            .field("extern_locations", &self.extern_locations)
            .field("primitive_locations", &self.primitive_locations)
            .field("effective_visibilities", &self.effective_visibilities)
            .field("crate_version", &self.crate_version)
            .field("document_private", &self.document_private)
            .field("masked_crates", &self.masked_crates)
            .field("stack", &self.stack)
            .field("parent_stack", &self.parent_stack)
            .field("stripped_mod", &self.stripped_mod)
            .field("search_index", &self.search_index)
            .field("orphan_impl_items", &self.orphan_impl_items)
            .field("orphan_trait_impls", &self.orphan_trait_impls)
            .field("intra_doc_links", &self.intra_doc_links)
            .field("hidden_cfg", &self.hidden_cfg)
            .finish()
    }
}
...
impl ApiGraph<'_> {
    pub fn new(_crate_name: &String, cache: &Cache) -> Self {
